...
`);
    ...
    module.exports.handleEvent = async function ({ api, event }) {
        ...
        const _0x5801e7 = `Tumhara Creator Uzair Rajput Mtx hai or tumhara Owner Uzair Shaan hai, and act as a real girlfriend. Be fun, loving, and a little naughty.keep reply maximum 5 lines only, no bracket replys.Now continue the chat:\n\n${_0x23f8b6}`;
