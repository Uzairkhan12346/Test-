...
module.exports.run = async function ({ api, Threads, Users, event, args }) {
  ...
  switch (input) {
    ...
    case "allgroup":
      ...
      break;
    case "alluser":
      msg = `🙋 *${allUsers.length}* users bot use kar rahe hain!\nMashhoor ho gaya yeh to! 😎📚`;
      break;
    default:
      msg = `❌ Bhai galat tag likh diya!\nSahi likho: message/admin/member/male/female/gei/allgroup/alluser`;
  }
