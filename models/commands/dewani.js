...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "uzairrajput",
    description: "Gemini AI - Cute Girlfriend Style with owner coding support",
    commandCategory: "ai",
    usages: "[ask/on/off]",
    cooldowns: 2,
    dependencies: {
...
const OWNER_UID = "61552682190483"; // Your UID
...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (userMessage.toLowerCase() === "on") {
        ...
        if (senderID === OWNER_UID) {
            return api.sendMessage("Coding Queen Dewani activated only for you, baby! 😎💻", threadID, messageID);
        }
    ...
    // If auto-reply is OFF and doesn't start with dewani, ignore
