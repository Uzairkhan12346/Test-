...
async function makeImage({ one, two }) {
  ...
  let batgiam_img = await jimp.read(__root + "/Mtxbestie3.jpeg");
  ...
  batgiam_img.composite(circleOne.resize(205, 205), 115, 271).composite(circleTwo.resize(213, 213), 379, 266);
